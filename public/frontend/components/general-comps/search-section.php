...
<h2 class="text-2xl font-bold mb-4 text-center">Filtres de recherche</h2>
...
<div class="bg-white p-6 border-b-8 border-blue-400 rounded-lg shadow-md">
        <div class="flex flex-col md:flex-row items-center md:justify-between">
            ...
            <input type="number" name="budget" min="200" max="10000" class="w-full md:w-1/4 px-4 py-2 border border-gray-300 rounded mb-4 md:mb-0 md:ml-4 outline-blue-400" id="budget" placeholder="Budget">
