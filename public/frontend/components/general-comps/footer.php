            ...
            <div class="flex flex-wrap justify-between">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="ml-6">(243) 970 211 981</p>
                    </div>
                </div>

                <!-- Newsletter Section -->
                <div class="w-full md:w-1/2 lg:w-1/3 mb-6">
                    <h2 class="text-xl font-bold mb-4">Rejoignez notre Newsletter</h2>
                    <form action="#">
                        <input type="email" class="w-full p-2 mb-4 text-gray-700 rounded" placeholder="Email">
                        <button type="submit" class="bg-yellow-500 text-gray-900 px-4 py-2 rounded">S'ABONNEZ</button>
                    </form>
