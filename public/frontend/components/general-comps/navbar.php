        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8 mx-auto text-lg">
                ...
                <div class="relative group flex flex-row">
                    ...
                    <div class="absolute hidden group-hover:block z-50 bg-blue-400 text-white shadow-lg rounded mt-1 p-2 text-nowrap">
                ...
                <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                    ...
                    <div class="absolute hidden group-hover:block bg-white shadow-lg rounded mt-1 px-2 text-nowrap">
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-200">Centre de formation</a>
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-200">Formation en ligne</a>
                    </div>
                </div>
